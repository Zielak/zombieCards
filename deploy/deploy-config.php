 ...
 * @var string
 */
define('SECRET_ACCESS_TOKEN', 'elemelekurdebele');
 ...
 * @var string
 */
define('REMOTE_REPOSITORY', 'https://github.com/Zielak/zombieCards.git');
 ...
 */
define('TARGET_DIR', '~/domains/karty.zielak.pl/public_html/');
 ...
 */
define('EMAIL_ON_ERROR', 'kontakt@zielak.pl');